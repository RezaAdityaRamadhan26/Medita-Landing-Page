...
export default function CTABanner() {
  ...
  return (
    <section className="bg-accent-mint">
      <div className="container-main px-4 lg:px-8 py-12 md:py-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <Link
          href="#contact"
          className="shrink-0 inline-flex items-center bg-primary-green text-white font-semibold text-sm md:text-base px-8 py-3.5 rounded-button hover:bg-primary-green-hover transition-colors duration-200 shadow-md hover:shadow-lg"
        >
