...
export default function ArticleCard({ article }: ArticleCardProps) {
  return (
    <Link
      ...
      className="group block bg-white rounded-card border-2 border-neo-black shadow-neo hover:translate-y-[-2px] hover:shadow-neo-lg transition-all duration-200 overflow-hidden"
    >
      {/* Thumbnail */}
      <div className="relative overflow-hidden aspect-[469/244] border-b-2 border-neo-black bg-slate-50">
        {article.cover_image ? (
          <Image
      ...
      <div className="p-5">
        ...
        <p className="text-xs text-neutral-muted mb-3">{article.publishedAt}</p>
        <p className="text-sm text-neutral-muted leading-relaxed line-clamp-3 mb-4">
          {article.excerpt}
        </p>
        <span className="inline-flex items-center gap-1 text-sm font-medium text-secondary-blue hover:underline">
          Read More
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
